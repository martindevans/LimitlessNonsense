...
public sealed class PipelineTests
{
    ...
    // Empty pipeline
    [TestMethod]
    public async Task Apply_EmptyPipeline_DoesNotThrow()
    {
    ...
    // Single middleware
    [TestMethod]
    public async Task Apply_SingleMiddleware_IsInvoked()
    {
        var called = false;
    ...
    [TestMethod]
    public async Task Apply_SingleMiddleware_ReceivesCorrectContext()
    {
    ...
    [TestMethod]
    public async Task Apply_MultipleMiddleware_AreCalledInOrder()
    {
    ...
    [TestMethod]
    public async Task Apply_MultipleMiddleware_SameContextPassedToAll()
    {
    ...
    [TestMethod]
    public async Task Apply_MiddlewareShortCircuits_SubsequentMiddlewareNotCalled()
    {
    ...
    [TestMethod]
    public async Task Apply_MiddlewarePostProcessing_RunsAfterDownstreamMiddleware()
    {
